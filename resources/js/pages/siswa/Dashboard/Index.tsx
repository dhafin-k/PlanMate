            ...
            <div className='flex h-full flex-1 flex-col gap-6 rounded-xl p-6 bg-gradient-to-br from-background to-muted'>
                <div className='flex justify-between items-center'>
                    ...
                    <div className='flex gap-2'>
                        ...
                        <Link href='/siswa/tasks'>
                            <Button className='bg-primary hover:bg-primary/90 border-primary/20  shadow-lg'>
                ...
                <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-3'>
                    ...
                    <Card className='bg-gradient-to-br from-purple-500/10 to-purple-600/10 border-gray-500/20'>
                        ...
                        <CardContent>
                            <div className='text-2xl font-bold text-purple-500'>{stats.totalTask}</div>
                    ...
                    <Card className='bg-gradient-to-br from-green-500/10 to-green-600/10 border-green-500/20'>
                        ...
                        <CardContent>
                            <div className='text-2xl font-bold text-green-500'>{stats.tugasSelesai}</div>
                            <p className='text-sm text-muted-foreground'>
                                Tugas terselesaikan
                            </p>
                        </CardContent>
                    ...
                    <Card className='border-primary/20'>
                        ...
                        <div className='space-y-4 '>
                            <div className='flex items-center gap-4'>
                                <div className='rounded-full bg-primary/10 p-2 cursor-pointer'
                                    onClick={() => router.visit('/siswa/tasks')}>
